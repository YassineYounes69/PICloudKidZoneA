...
public class ParentController {
    ...
    public Parent updatePwById(@PathVariable Long id,@PathVariable String Pw){
        Parent parent = new Parent();
        if (parentRepository.findById(id).isPresent()){
            parent = parentRepository.findById(id).get();
            parent.setPw(Pw);
    ...
    public Parent updateEmailById(@PathVariable Long id,@PathVariable String Email){
        Parent parent = new Parent();
        if (parentRepository.findById(id).isPresent()){
            parent = parentRepository.findById(id).get();
    ...
    public Parent updateLastNameById(@PathVariable Long id,@PathVariable int pn){
        Parent parent = new Parent();
        if (parentRepository.findById(id).isPresent()){
            parent = parentRepository.findById(id).get();
            parent.setpTel(pn);
